...
<div class="row"> 
 ...
 <div class="col-md-3 form-group">
      ...
      <div class="input-group mb-2">
        ...
        <input type="text" class="form-control @if ($errors->any()) {{$errors->has('price') ? 'is-invalid':'is-valid'}} @endif" id="price" name="price" placeholder="Price for extra " value="{{ old('price') }}" required="true">
