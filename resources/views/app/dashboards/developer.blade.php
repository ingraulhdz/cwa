...
@section('content')
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard for Developer</h1>
                        <h3 class=" text-gray-400">{{ Auth::user()->employee->rol->name}}</h3>

            <div class="d-none d-sm-inline-block ">

              <small class="text-gray-500">Last updated</small>
              <font class="btn btn-sm btn-primary shadow-sm" id="today"></font>
            </div>
          </div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Cars Overview</h6>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <canvas id="carsStatus"></canvas>
                  </div>
                  <div class="mt-4 text-center small" id="labels_pie">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Employees Overview</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <canvas id="carsByEmployee"></canvas>
                  </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py- d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Dealers Overview</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
...
function carsByEmployee(data){
new Chart(document.getElementById("carsByEmployee"), {
    type: 'horizontalBar',
    data: {
