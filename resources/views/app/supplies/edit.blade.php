...
<div class="row"> 
  ...
  <div class="col-md-5 form-group">
      ...
      <div class="input-group mb-2">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="supply name" value="{{ $supply->name }}" required="true">
      </div>
  </div>
 ...
 <div class="col-md-4 form-group">
      ...
      <div class="input-group mb-2">
        ...
        <input type="text" class="form-control" id="description" name="description" placeholder="Short description" value="{{ $supply->description }}" required="true">
      </div>
  </div>
 ...
 <div class="col-md-2 form-group">
      ...
      <div class="input-group mb-2">
        ...
        <input type="number" class="form-control" id="price" name="price" placeholder="$ Price " value="{{ $supply->price}}" required="true">
