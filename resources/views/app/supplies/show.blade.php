...
<b>Information</b>      </div>
    ...
    <li class="list-group-item"><b>Name: </b>{{$supply->name}}</li>
    <li class="list-group-item"><b>Description: </b>{{$supply->description}}</li>
    <li class="list-group-item"><b>Price: </b>$ {{$supply->price}}.00</li>
